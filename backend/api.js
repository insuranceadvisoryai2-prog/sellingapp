...
export const generateImportToken = () => req('/api/admin/generate-import-token', { method: 'POST' });
export const updateOrderStatus = (id, status) => req(`/api/orders/${id}/status`, { method:'PATCH', body:JSON.stringify({status}) });
