// db.js — Neon PostgreSQL (works perfectly on Render free tier)
import pg from 'pg';
const { Pool } = pg;
...
export async function updateProduct(id, updates) {
  const allowed = ['name','description','price','original_price','image_url',
                   'category','subcategory','brand','stock','is_active','is_published'];
  const fields = [], values = [];
  let i = 1;
