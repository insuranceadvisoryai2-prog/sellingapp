...
function detectCategory(text, existingCat) {
  const t = ((text||'') + ' ' + (existingCat||'')).toLowerCase();
  const rules = [
    { keys: ['saree','sari','kurti','lehenga','salwar','dupatta','anarkali','blouse','ghagra','churidar','palazzo','sharara'], cat: "Women's Clothing" },
    { keys: ['kurta set','sherwani','dhoti','pathani','nehru jacket','indo western','men kurta','bandhgala'], cat: "Kurta & Ethnic Wear" },
    { keys: ['kids wear','boys clothing','girls dress','baby clothes','school uniform','baby frock'], cat: "Kids' Clothing" },
    { keys: ['shoe','sandal','slipper','heel','boot','footwear','chappal','loafer','sneaker','mojari','wedge'], cat: "Footwear" },
    { keys: ['necklace','earring','ring','bangle','bracelet','anklet','jewellery','jewelry','pendant','mangalsutra','maang tikka','jhumka','kundan','oxidised'], cat: "Jewellery" },
    { keys: ['lipstick','foundation','mascara','serum','moisturiser','shampoo','conditioner','hair oil','face wash','perfume','deodorant','kajal','nail polish','makeup','skincare'], cat: "Beauty & Health" },
    { keys: ['handbag','purse','clutch','backpack','suitcase','trolley bag','tote bag','potli','sling bag','wallet'], cat: "Bags & Wallets" },
    { keys: ['bedsheet','pillow cover','curtain','cushion','quilt','blanket','wall art','lamp','diya','candle','pooja','artificial flower'], cat: "Home & Decor" },
    { keys: ['cookware','kadai','tiffin','lunch box','dinner set','pressure cooker','non stick','frying pan','water bottle','flask','casserole'], cat: "Kitchen & Dining" },
    { keys: ['mobile cover','phone case','earphone','headphone','charger','cable','power bank','smartwatch','bluetooth speaker','led light'], cat: "Electronics & Accessories" },
    { keys: ['toy','teddy','doll','action figure','puzzle','board game','building block','remote control toy','soft toy','craft kit'], cat: "Toys & Baby Products" },
    { keys: ['baby care','diaper','nappy','stroller','pram','feeding bottle','rattle'], cat: "Toys & Baby Products" },
    { keys: ['cricket','football','badminton','yoga mat','dumbbell','gym','fitness','cycle','exercise','workout'], cat: "Sports & Fitness" },
    { keys: ['diwali','holi','rakhi','wedding gift','return gift','gift hamper','festival decoration'], cat: "Festive & Gifting" },
    { keys: ['pen','pencil','notebook','diary','art supply','sketch','stationery'], cat: "Stationery & Craft" },
    { keys: ['car cover','car seat','steering cover','car accessory','bike accessory'], cat: "Automotive" },
    { keys: ['dog food','cat food','pet toy','pet collar','aquarium'], cat: "Pet Supplies" },
    { keys: ['women','ladies','female','girl'], cat: "Women's Clothing" },
    { keys: ['men trouser','men jeans','men shirt','polo shirt','gents','formal shirt'], cat: "Men's Clothing" },
    { keys: ['kids','children','child','infant','toddler','junior'], cat: "Kids' Clothing" },
  ];
