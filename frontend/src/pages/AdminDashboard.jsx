...
function buildBookmarklet(backendUrl, importToken) {
  ...
  parts.push('var pr=df(nd,["current_price","selling_price","discounted_price","price","sp","finalPrice","offerPrice"],12);');
  parts.push('var mr=df(nd,["mrp","original_price","market_price","cp","listPrice"],12);');
  ...
  parts.push('if(p===0&&m>0){p=m;m=0;}'); // use MRP as price if price missing
